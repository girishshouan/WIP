...
namespace Oculus.Movement.BodyTrackingForFitness
{
    ...
    /// </summary>
    public class FullBodySkeletonTPose : ISkeletonMapping, IBodyPose
    {
        /// <summary>
        ...
        private static BoneLink<BodyJointId>[] _boneLinks =
        {
            ...
            (BodyJointId.Body_LeftScapula, BodyJointId.Body_LeftShoulder, BodyJointId.Body_LeftArmUpper,
                new Vector3(177,154.41f,-121.42f), ((-.16f,1.447f,-.032f), (78.424f,280.995f,295.236f))),
            (BodyJointId.Body_LeftArmUpper, BodyJointId.Body_LeftShoulder, BodyJointId.Body_LeftArmLower,
            ...
            (BodyJointId.Body_LeftHandWristTwist, BodyJointId.Body_LeftArmLower, BodyJointId.Body_LeftHandPalm,
                EulerLeft, ((-.667f,1.394f,-.029f), (62.256f,18.931f,17.883f))),
            ...
            (BodyJointId.Body_RightScapula, BodyJointId.Body_RightShoulder, BodyJointId.Body_RightArmUpper,
                new Vector3(1.77f,155.42f,120.99f), ((.16f,1.447f,-.032f), (281.577f,259.005f,115.236f))),
            (BodyJointId.Body_RightArmUpper, BodyJointId.Body_RightShoulder, BodyJointId.Body_RightArmLower,
            ...
            (BodyJointId.Body_RightHandWristTwist, BodyJointId.Body_RightArmLower, BodyJointId.Body_RightHandPalm,
                EulerRight, ((.667f,1.394f,-.029f), (306.327f,165.679f,193.964f))),
            (BodyJointId.Body_LeftHandPalm, BodyJointId.Body_LeftHandWristTwist, BodyJointId.Body_LeftHandWrist,
                EulerLeft, ((-.728f,1.391f,-.006f), (7.164f,186.58f,173.242f))),
            (BodyJointId.Body_LeftHandWrist, BodyJointId.Body_LeftHandPalm, BodyJointId.Body_LeftHandThumbMetacarpal,
            ...
            (BodyJointId.Body_RightHandPalm, BodyJointId.Body_RightHandWristTwist, BodyJointId.Body_RightHandWrist,
                EulerRight, ((.728f,1.391f,-.006f), (352.836f,353.42f,353.242f))),
            (BodyJointId.Body_RightHandWrist, BodyJointId.Body_RightHandPalm, BodyJointId.Body_RightHandThumbMetacarpal,
